...
import type { CreateAttemptInput, GetSubmissionsInput, GetMostCommonMistakesInput, GetAnalyticsCardsInput, GetConceptMappingActivityInput, SubmitAttemptSchema, GetConceptMappingAssignmentByIdInput, CreateAssignmentAttemptInput } from "./conceptMapping.input";
...
export const getConceptMappingAssignmentById = async (ctx: ProtectedTRPCContext, input: GetConceptMappingAssignmentByIdInput) => {
  const assignment = await ctx.db.query.conceptMappingAssignments.findFirst({
