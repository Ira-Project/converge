  ...
  switch(activityType) {
    ...
    case ActivityType.ReadAndRelay:
      return {
        ...
        tutorialUrl: "https://www.loom.com/embed/02a0e5636ea54e759aae40e6402966df?sid=af1d6394-c03e-4f89-93b5-09e7dff7c3fe",
        tags: [SkillType.ANALYZING, SkillType.UNDERSTANDING],
        colour: "blue",
        description: "Read a passage and highlight the key concepts and formulas.",
        descriptionLong: "",
        citations: [],
        isActive: false,
      }
